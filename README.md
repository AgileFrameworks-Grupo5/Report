...
- Se considera que los estudiantes son un segmento objetivo, ya que pueden utilizar el juego educativo de matemáticas en 2D como una herramienta adicional para aprender y reforzar sus conocimientos. Además de que pueden disfrutar de un juego educativo que sea entretenido y desafiante.
-Además les permite explorar conceptos matemáticos de manera interactiva y visual, lo que puede facilitar la comprensión de los temas.
